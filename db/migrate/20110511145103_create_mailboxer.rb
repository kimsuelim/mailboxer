class CreateMailboxer < ActiveRecord::Migration
  ...
  #Foreign keys
  	#Conversations
  	#Receipts
  	add_foreign_key "mailboxer_receipts", "notifications", :name => "receipts_on_notification_id"
  	#Messages
  	add_foreign_key "mailboxer_notifications", "conversations", :name => "notifications_on_conversation_id"
  end
